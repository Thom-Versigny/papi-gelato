...
def vraagbolljes():
	while True:
		aantal = int(input(f"Hoeveel {bolletjesORliter} wilt u? "))
		if bolletjesORliter=='bolletje':
			if aantal == 1 or aantal == 2 or aantal == 3:
				return aantal
			elif aantal == 4 or aantal == 5 or aantal == 6 or aantal == 7 or aantal == 8:
				print(f'Dan krijgt u van mij een bakje met {aantal} {bolletjesORliter}')
				return aantal
			elif aantal > 8:
